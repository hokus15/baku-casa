...
def test_password_change_returns_204(bootstrapped_client: TestClient, auth_token: str) -> None:
...
def test_password_change_without_token_returns_401_with_error_schema(
...
def test_password_change_wrong_current_returns_401(bootstrapped_client: TestClient, auth_token: str) -> None:
    resp = bootstrapped_client.put(
        "/api/v1/auth/password",
