...
- [ ] T017 [US1] Add validation, typed errors, and conflict handling
- [ ] T018 [US1] Add structured logging with correlation propagation
...
- [ ] T019 [P] [US2] Contract test for [endpoint/event] in tests/contract/test_[name].py
...
- [ ] T025 [P] [US3] Contract test for [endpoint/event] in tests/contract/test_[name].py
...
- [ ] TXXX [P] Documentation updates in docs/spec for behavior changes
- [ ] TXXX [P] ADR update/new ADR for structural changes
